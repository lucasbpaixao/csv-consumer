...
public class UploadRestController {
    ...
    @PostMapping
    public ResponseEntity<List<Column>> upload(@RequestParam(name="csvFile") MultipartFile csvFile, @RequestParam(name="tableName") String tableName, @RequestParam(name="primaryKeyField") String primaryKeyField) throws IOException {
